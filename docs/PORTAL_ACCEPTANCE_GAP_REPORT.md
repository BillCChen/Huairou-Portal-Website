...
V1 中首页、新闻、案例、关于我们、登录、注册、审核、领导团队已有基础实现，但尚不能按合同验收闭环描述。主要缺口包括：机构用户管理员分配、拒绝/禁用/启用、角色赋权、权限矩阵、测试报告、性能压测、安全扫描、生产部署验收。
...
| 手机号验证码登录 | 仅测试外壳 | /auth/sms-send, SMS_TEST_CODE | 无真实 provider、限流 | P2 |
