...
V1 中首页、新闻、案例、关于我们、登录、注册、审核、领导团队已有基础实现。P1-B/P1-C 已完成邮箱密码重置后端与前端基础；P1-D 已完成机构用户管理员创建、审核驳回、禁用/启用、角色赋权和用户生命周期 smoke。剩余主要缺口包括：内容 CMS 验收收束、权限矩阵扩展测试、测试报告、性能压测、安全扫描、生产部署验收。
